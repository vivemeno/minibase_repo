	...
	*/
    ...
    private void MIN_VAL(Tuple lastElem, AttrType sortFldType)
        ...
        switch (sortFldType.attrType) {
            ...
            case AttrType.attrInterval:
                //      lastElem.setHdr(fld_no, junk, s_size);
                lastElem.setIntervalFld(_sort_fld, new IntervalType(INTRVL_MIN_START_VAL, INTRVL_MIN_END_VAL, INTRVL_MIN_LEVEL_VAL));
                break;
            default:
    ...
    private void MAX_VAL(Tuple lastElem, AttrType sortFldType)
        ...
        switch (sortFldType.attrType) {
            ...
            case AttrType.attrInterval:
                //      lastElem.setHdr(fld_no, junk, s_size);
                lastElem.setIntervalFld(_sort_fld, new IntervalType(INTRVL_MAX_START_VAL, INTRVL_MAX_END_VAL, INTRVL_MAX_LEVEL_VAL));
                break;
            default:
                // don't know how to handle attrSymbol, attrNull
                //System.err.println("error in sort.java");
