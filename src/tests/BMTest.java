...
class BMDriver extends TestDriver implements GlobalConst {
  ...
  protected boolean test1 () {
    ...
    PageId firstPid = new PageId();
      System.out.print("  -NO. of unpinned buffers="+numPages+"\n");
    ...
    lastPid = new PageId();
      ...
      System.out.print("last pid="+lastPid.pid);
	...
	SystemDefs.JavabaseBM.pinPage( pid, pg, /*emptyPage:*/ true);
      ...
      catch (Exception e) {       System.out.print("first pid="+firstPid.pid);
  ...
  protected boolean test2 () {
	...
	status = FAIL;https://docs.google.com/document/d/1OY8ffnilYk957UlfX_acFvlk4g_yIElU_fc7TN0DeWM/edit
