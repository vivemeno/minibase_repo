...
import compositeTree.InsertRecException;
import diskmgr.Page;
...
public class ITSortedPage  extends HFPage{
  ...
  int keyType = 5; //defaults to intervalType
	 ...
	 for (i=getSlotCnt()-1; i > 0; i--) 
	   {
	     ...
	     key_i=IntervalT.getEntryFromBytes(getpage(), getSlotOffset(i), 
					getSlotLength(i), keyType, nType).key;
	     
	     key_iplus1=IntervalT.getEntryFromBytes(getpage(), getSlotOffset(i-1), 
